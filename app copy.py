...
if st.sidebar.button("Data Analysis"):
    st.session_state.page = "Data Analysis"
if st.sidebar.button("⚖️ Compare Models"):
    st.session_state.page = "Compare Models"
if st.sidebar.button("🩺 Classify Custom Entry"):
    st.session_state.page = "Classify Custom Entry"

st.sidebar.markdown("---")
st.sidebar.info("Breast Cancer Wisconsin (Diagnostic) Data Set\n\nDeveloped with ❤️ using Streamlit")
...
elif st.session_state.page == "Compare Models":
    st.write("Provide model selection, training, and performance comparison here.")

elif st.session_state.page == "Classify Custom Entry":
    st.write("Provide form inputs for manual feature entry and show classification result here.")
